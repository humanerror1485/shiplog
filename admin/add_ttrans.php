...
<head>
    <title>add transaksi transportasi</title>
</head>
...
<body>
    ...
    <br>
    <br>
    <form action="add_ttrans.php" method="post" name="form1" enctype="multipart/form-data">
...
if (isset($_POST['submit'])) {
    ...
    $id_user = $_POST['id_user'];
            ...
            $result = mysqli_query($koneksi, "INSERT INTO transaksi_transportasi
