...
$result = mysqli_query($koneksi, "SELECT * FROM transaksi_logistik WHERE id_transaksi=$id_transaksi");
...
<body>
    ...
    <br>
    <br>
    <form action="update_tlogistik.php" method="post" name="update" enctype="multipart/form-data">
