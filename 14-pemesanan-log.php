...
$sql = "SELECT * FROM tiket_kapallogistik WHERE id_schedule='$id'";
...
<body>
    ...
    <section >
        <div class="overlay">
            ...
            <h2 style="color:#0d0870; margin-bottom: 7px;">Transaksi Reservasi Logistik</h2>
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
            <div class="container">
                    ...
                    <tr>
                        <td width="25%">
                            <div class="containerr">
                                ...
                                <label class="sub-title">Jenis</label><br>
                                <input class="register-input" type="text" value="<?= $type ?>"><br>
                                <label class="sub-title">Muatan</label><br>
                                <input class="register-input" type="text" value="<?= $quantity ?>" ><br>
                            </div>
                            <div class="containerr">
                                ...
                                <input class="register-input" type="text" value="<?= $date_dest ?>"><br>
                            </div>
                        </td>
                            ...
                            <div class="containerrr">
                                ...
                                <div class="register-row">
                                    ...
                                    <div class="containerrrr">
                                        ...
                                        <form action="update_tlogistik.php" method='post' >
                                            <div>
                                                <h5 style="color: black; margin-bottom: 20px; font-size: larger;">Rincian Harga</h5>
                                            </div>
                                            <div>
                                                <span style="color: black; margin-bottom: 10px;">1x Tiket <?=$class  ?></span>
                                                <span style="color: black; margin-left: 250px;">Rp.<?=$price  ?></span><hr style="height:2px;border-width:0;color:gray;background-color:gray; margin: 5px 0px 5px 0px;">
                                            </div>
                                            <div>
                                                <span style="color: black;">Harga Total</span>
                                                <span style="color: black; margin-left: 250px;">Rp.<?=$harga  ?></span>
