...
if (isset($_POST['cari'])) {
    ...
    $date = $_POST['date'];
    $class = $_POST['class'];
    $result = mysqli_query($conn, "SELECT * FROM tiket_kapaltransportasi 
    WHERE `route` = '$route' and `date_dep` = '$date' and `class` = '$class'
...
<body>
    ...
    <section >
        <div class="overlay">
            <a href="9-transportation.php"> <i class="fa fa-arrow-left" style="font-size: 20px; color: #0d0870; margin-bottom: 20px;"></i> </a>
            <h2 style="color:#0d0870; margin-bottom: 7px;">Tiket Transportasi</h2>
                ...
                echo"<table border='0' width='100%'>";
                    echo"<tr>";
                                ...
                                echo "<table border='0' width='100%'>";
                                    echo "<tr>";
                                       echo" <td width='40%'>";
                                            ...
                                            echo"<span class='text-d'>".$tiket_data['time_dep']."</span>"."<br>";
                                        ...
                                        echo"<td width='40%' align='right'>";
                                            echo"<span class='text-a'>".$tiket_data['price']."</span>"."<br>";
                                            echo"<span class='text-f'>".$tiket_data['capacity']."</span>"."<br>"."<br>";
                                            echo"<span class='text-c'>".$tiket_data['route']."</span>"."<br>";
                                            echo"<span class='text-d'>".$tiket_data['time_dest']."</span>"."<br>";
                        ...
                        echo"<div class='button'>";
                                echo"<button><a href='13-pemesanan.php?id_schedule=$tiket_data[id_schedule]' class='button-a' >Pesan</button></a>";                      
                            echo"</div>";
                        echo"</td>";
                    echo"</tr>";
                echo "</table>";
