...
<body>
    ...
    <section >
        <div class="overlay">
            ...
            <span>Halo, kamu mau kirim kemana?</span>
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
            <div class="container">
                <table border="0" width="100%">
                  <tr height="100px">
                    <td width="45%" >
                    <form action="12-logistic-ticket.php" method="post">
                ...
                <form action="12-logistic-ticket.php">
                    <td width="45%">
                      <h1 class="sub-title">Pelabuhan Kedatangan</h1>
                      <select id="" name="route" class="x-input" >
                        <option value="Pel. Tanjung Priok, Jakarta">Pel. Tanjung Priok, Jakarta</option>
                        <option value="Pel. Gilimanuk, Bali">Pel. Gilimanuk, Bali</option>
                      </select>
                    </td>
                  </tr>
                </table>
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
                <table border="0" width="100%" style="margin-top: 15px;">
                  <tr height="100px">
                    ...
                    <td width="20%">
                      <h1 class="subs-title">Jenis Barang</h1>
                      <select id="" name="type" class="i-input" >
                    ...
                    <td width="15%">
                        <h1 class="subs-title">Berat</h1>
                        <select id="" name="quantity" class="z-input" >
                    ...
                    <td width="15%" >
                      <input class="btn-x" type="submit" name='cari' value="Cari">
                    </td>
                  </tr>
                </table>
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
