...
<body>
    ...
    <section >
        <div class="overlay">
            <a href="1-index.php"> <i class="fa fa-arrow-left" style="font-size: 20px; color: #0d0870; margin-bottom: 20px;"> Kembali</i></a>
            <h2 style="color:#0d0870; margin-bottom: 7px; text-align: center;" >Tutorial Pemesanan Tiket Kapal Logistik</h2>
<!----------------------------------------------------------------------------------------------------------------------------------------------------->
            <div class="container">
                <img src="image/tutor-log.png" alt="" style="width: 100%;">
            </div>
